...
def train(model, train_iterator, vaild_iterator, optimizer,scheduler,num_epochs, save_every,file_path ,best_valid_loss, reload_from_checkpoint=False, load_path_checkpoint=None,load_path_metrics=None):
    ...
    for epoch in range(start_epoch,num_epochs):
        ...
        average_train_loss = running_loss / cou
